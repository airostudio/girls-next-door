        ...
        <div className="card">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#24292e] hover:bg-[#2f363d] text-white font-medium px-4 py-2.5 rounded-lg transition-colors text-sm"
            >
              <GitHubIcon />
